...
function drawPlan(){
  ...
  $("planBody").innerHTML = `
    ...
    <table data-pershop="${perShop}" data-shops="${shops}" data-peak="${D.plan.peak || 1}" data-ingtips="${attr(JSON.stringify(tips))}">
...
function planDraw(){
  ...
  lines.forEach(tr => {
    ...
    set(".covers", peakDay ? Math.floor(wk / 7 / peakDay) + " shops" : "—");
